    ...
    var quizOptions = {
        "low": {
             ...
             "1": {
                ...
                ,"answer": "Мы можем предложить: Облако, 1С:ГТД. Курсы, либо покупку софта и ИТС. Оставь контакты, жлоб :-)"
             }
            ,"2": {
                 "choice": "Мне нужно понять что какого обслуживание какого качества я могу получить за свои деньги."
                ,"answer": "Если мы можем открыто сможем говорить о бюджете, то сможем сформулировать некороторый стандарт качества услуг, на которые можно рассчитывать. Оставь контакты, и мы все обстоятельно обсудим :-)"
            }
            ,"3": {
                 "choice": "Я - энтузиаст.  Меня интересует качество прежде всего."
                ,"answer": "Осторожнее пожалуйста!  Энтузиазм при внедрении нужно нормировать, т.к. это длинная дистанция. Такие клиенты наши любимые - с ними всегда что-то интересное делаем. Оставь контакты и мы сможем что-то интересное предложить."
            }
        },
        "medium": {
             ...
             "1": {
                 ...
                 ,"answer": "Это бывает. Давайте посмотрим что у вас не получается в текущей ситуации. Поговорите с нами об этом, и мы постараемся придумать, как вам помочь. Контактики не забудьте оставить :-)"
             }
            ,"2": {
                 "choice": "Мне интересно грамотное использование уже имеющегося функционала."
                ,"answer": "Давайте посмотрим, что осталось за бортом автоматизации и вместе подумаем как можно использовать имеющийся функционал. Оставьте контакты :-)"
            }
            ,"3": {
                 "choice": "Мне требуется развитие или пересмотр имеющейся системы."
                ,"answer": "Здесь видится полезным аудит и предложения по оптимизации. Контакты оставьте и мы пообщаемся."
            }
        }
        ,
        "pro": {
